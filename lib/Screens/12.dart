...
import 'package:telescope_dml_eleicoes_vinhedo/Screens/13.dart';
import 'package:telescope_dml_eleicoes_vinhedo/services/globals.dart'
    as globals;

class ImpedimentoScreen extends StatefulWidget {
  ...
  @override
  _ImpedimentoScreenState createState() => _ImpedimentoScreenState();
}

class _ImpedimentoScreenState extends State<ImpedimentoScreen> {
  saveDataSurvey() {
    widget.checkItems.forEach((value) {
      if (value.checked) {
        globals.singleSurvey.candidatos_cartao1_segunda_opcao = value.label;
      }
    });
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                        'Se o candidato que o senhor escolheu, tiver algum impedimento, quem o Sr.(a) votaria como segunda opção?',
                      ...
                      onPressed: () {
                        ...
                        if (qtdCheck <= 0) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => CandidatoNaoVotaria()));
                        }
                      },
                    ))
              ],
