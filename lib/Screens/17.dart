...
import 'package:telescope_dml_eleicoes_vinhedo/Screens/18.dart';
import 'package:telescope_dml_eleicoes_vinhedo/services/globals.dart'
    as globals;

class ChanceVitoriaScreen extends StatefulWidget {
  ...
  @override
  _ChanceVitoriaScreenState createState() => _ChanceVitoriaScreenState();
}

class _ChanceVitoriaScreenState extends State<ChanceVitoriaScreen> {
  saveDataSurvey() {
    widget.checkItems.forEach((value) {
      if (value.checked) {
        globals.singleSurvey.novo_candidato_venceria = value.label;
      }
    });
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                        'O Sr.(a) acha que esse novo candidato teria chances para vitória?',
                      ...
                      onPressed: () {
                        ...
                        if (qtdCheck <= 0) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ProfissoesScreen()));
                        }
                      },
                    ))
              ],
