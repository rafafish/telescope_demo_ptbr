...
import 'package:telescope_dml_eleicoes_vinhedo/Screens/12.dart';
...
class ViceScreen extends StatefulWidget {
  ...
  @override
  _ViceScreenState createState() => _ViceScreenState();
}
...
class _ViceScreenState extends State<ViceScreen> {
  saveDataSurvey() {
    widget.checkItems.forEach((value) {
      if (value.checked) {
        globals.singleSurvey.candidatos_cartao1_votaria_vice = value.label;
      }
    });
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                        'Dentre esses mesmos candidatos, qual seria a melhor opção para ser vice-prefeito do candidato de sua escolha?',
                      ...
                      onPressed: () {
                        ...
                        if (qtdCheck <= 0) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ImpedimentoScreen()));
                        }
                      },
                    ))
              ],
