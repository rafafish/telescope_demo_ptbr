...
import 'package:telescope_dml_eleicoes_vinhedo/Screens/23.dart';
import 'package:telescope_dml_eleicoes_vinhedo/services/globals.dart'
    as globals;

class IndicadoScreen extends StatefulWidget {
  ...
  @override
  _IndicadoScreenState createState() => _IndicadoScreenState();
}

class _IndicadoScreenState extends State<IndicadoScreen> {
  saveDataSurvey() {
    widget.checkItems.forEach((value) {
      if (value.checked) {
        globals.singleSurvey.votaria_indicado_prefeito_atual = value.label;
      }
    });
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                        'Se o atual prefeito indicasse um candidato o Sr. (a):',
