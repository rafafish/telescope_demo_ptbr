...
import 'package:telescope_dml_eleicoes_vinhedo/Screens/16.dart';
import 'package:telescope_dml_eleicoes_vinhedo/services/globals.dart'
    as globals;

class SatisfeitoScreen extends StatefulWidget {
  ...
  @override
  _SatisfeitoScreenState createState() => _SatisfeitoScreenState();
}

class _SatisfeitoScreenState extends State<SatisfeitoScreen> {
  saveDataSurvey() {
    widget.checkItems.forEach((value) {
      if (value.checked) {
        globals.singleSurvey.satisfeito_opcoes_atuais = value.label;
      }
    });
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                        'O Sr. (a) está satisfeito com as opções atuais de candidatos da sua cidade?',
                      ...
                      onPressed: () {
                        ...
                        if (qtdCheck <= 0) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => NovoCandidatoScreen()));
                        }
                      },
                    ))
              ],
