...
import 'package:telescope_dml_eleicoes_vinhedo/Screens/22.dart';
import 'package:telescope_dml_eleicoes_vinhedo/services/globals.dart'
    as globals;

class NaoVotariaConhecidoScreen extends StatefulWidget {
  ...
  @override
  _NaoVotariaConhecidoScreenState createState() =>
      _NaoVotariaConhecidoScreenState();
}

class _NaoVotariaConhecidoScreenState extends State<NaoVotariaConhecidoScreen> {
  saveDataSurvey() {
    widget.checkItems.forEach((value) {
      switch (value.id) {
        ...
        case 2:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_marcio = 'X';
          }
          break;
        case 3:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_joao_bellenus = 'X';
          }
          break;
        case 4:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_joao_dellabruna = 'X';
          }
          break;
        case 5:
          if (value.checked) {
        ...
        case 6:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_geraldo = 'X';
          }
          break;
        case 7:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_coronel = 'X';
          }
          break;
        case 8:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_branco_nulo = 'X';
          }
          break;
        case 9:
          if (value.checked) {
            globals.singleSurvey
                .candidatos_cartao3_nao_votaria_prefeito_nenhum = 'X';
          }
          break;
        case 10:
          if (value.checked) {
            ...
            child: Column(
              ...
              children: <Widget>[
                Align(
                    ...
                    child: Text(
                        'Dentre esses candidatos teria algum que o Sr.(a) não votaria de jeito nenhum? (Pode ter mais de uma resposta)',
                      ...
                      onPressed: () {
                        ...
                        if (qtdCheck <= 0) {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => IndicadoScreen()));
                        }
                      },
                    ))
              ],
